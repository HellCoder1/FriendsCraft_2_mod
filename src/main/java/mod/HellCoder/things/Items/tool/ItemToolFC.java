...
public abstract class ItemToolFC extends ItemTool {
	...
	public ItemToolFC(float baseDamage, Item.ToolMaterial toolMaterial) {

		super(baseDamage, toolMaterial, null);
	}

	public ItemToolFC(float baseDamage, Item.ToolMaterial toolMaterial, int harvestLevel) {

		this(baseDamage, toolMaterial);
		this.harvestLevel = harvestLevel;
	}

	public ItemToolFC setRepairIngot(String repairIngot) {
