...
public class RMblock extends BlockContainer
{
    ...
    public RMblock(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityRM)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityRM tileentityironovenidle = (TileEntityRM)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
